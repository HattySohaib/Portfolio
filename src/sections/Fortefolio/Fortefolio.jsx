...
function Fortefolio() {
  ...
  return (
    <div id="fortefolio" className={`fortefolio-${themeMode}`}>
      ...
      >
        <p className="fortefolio-header">As a developer,</p>
        <p className="fortefolio-text">
          ...
          ways to help me improve my skills and stacks. If you have any
          suggestions, ideas or feedback that you’d like to share with me, feel
          free to drop a message or get in touch.
        </p>
      </motion.div>
      <motion.div
        initial={{ opacity: 0 }}
